...
<div x-cloak>
    ...
    <div class="fixed transition duration-500 rounded-md right-4 bottom-4 top-4 p-4 transform w-full xl:w-3/5 2xl:w-2/5 bg-primary-200 flex flex-col gap-8 border-l border-primary-300" :class="{'translate-x-full -right-0': !{{ $showVar }}}">
